...
@section('content_header')
    <h1>Registro de un nuevo Arqueo</h1>
    <hr>
@stop
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" value="{{ old('fecha_apertura_arqueo') }}" name="fecha_apertura_arqueo" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('monto_inicial_arqueo') }}" name="monto_inicial_arqueo">
