                    ...
                    <form action="{{ url('/admin/arqueos/create_cierre') }}" method="post">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" value="{{ old('fecha_cierre_arqueo')}}" name="fecha_cierre_arqueo" >
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="monto_final_arqueo">Monto final</label>
                                    <input type="text" class="form-control" value="{{ old('monto_final_arqueo')}}" name="monto_final_arqueo" >
