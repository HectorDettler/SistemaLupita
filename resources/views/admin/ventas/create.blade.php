                                ...
                                <div class="row">
                                    ...
                                    <table class="table table-sm table-striped table-bordered table-hover ">
                                        ...
                                        @foreach ( $tmp_ventas as $tmp_venta )
                                            ...
                                            <tr>
                                                <td style="text-align:center; vertical-align:middle">{{ $tmp_venta ->producto->nombre_producto}}</td>
                                                <td style="text-align:center; vertical-align:middle">{{ $tmp_venta ->producto->codigo_producto }}</td>
                                                <td style="text-align:center; vertical-align:middle">{{ $tmp_venta ->cantidad}}</td>
                                                <td style="text-align:center; vertical-align:middle">{{ number_format($tmp_venta->precio_unitario, 2) }}</td>
                                                <td style="text-align:center; vertical-align:middle">{{ $costo = $tmp_venta->cantidad * $tmp_venta->precio_unitario }}</td>
                                                <td style="text-align:center; vertical-align:middle">
                                                    <button  type="button" class="btn bg-gradient-danger btn-sm delete-btn" data-id="{{ $tmp_venta->id }}" ><i class="fas fa-trash"></i></button>
                                                    @if($tmp_venta->producto->precio_oferta_producto > 0)
                                                        <button type="button" class="btn btn-success btn-sm oferta-btn" data-id="{{ $tmp_venta->id }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ old('fecha_venta',date('Y-m-d')) }}" name="fecha_venta">
                                            @error('fecha_venta')
                                            <small style"">{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="tipo_pago_id" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="porcentaje_agregado" id="porcentaje_agregado" class="form-control"  value="{{ old('porcentaje_impuesto', 0) }}" required min="0">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-align:center; vertical-align:middle; background-color: #e9e710; " class="form-control" value="{{ $total_venta }}"  id="precio_total_venta" name="precio_total_venta"  data-original-total="{{ $total_venta }}" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn bg-gradient-primary btn-lg btn-block"><i class="fas fa-save"></i> Registrar</button>
